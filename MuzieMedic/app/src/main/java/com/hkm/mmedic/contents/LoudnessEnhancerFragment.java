...
import com.hkm.mmedic.model.LoudnessEnhancerStateStore;
...
public class LoudnessEnhancerFragment extends AudioEffectSettingsBaseFragment
    ...
    protected void onActionBarSwitchCheckedChanged(
        ...
        postAppEvent(EventDefs.LoudnessEnhancerReqEvents.SET_ENABLED, (isChecked ? 1 : 0), 0);
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        switch (seekBar.getId()) {
            case R.id.seekbar_loudness_enhancer_target_gain: {
                ...
                postAppEvent(EventDefs.VirtualizerReqEvents.SET_STRENGTH, 0, strength);
            }
                break;
        }
    }
