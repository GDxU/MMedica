...
import com.hkm.mmedic.model.BaseAudioEffectStateStore;
import com.hkm.mmedic.model.EventDefs;
import com.hkm.mmedic.model.MediaPlayerStateStore;
...
public class NavigationDrawerFragment extends AppBaseFragment {
    ...
    private static class AppEventReceiver extends AppEventBus.Receiver<NavigationDrawerFragment> {
        private static final int[] FILTER = new int[]{
                ...
                NOTIFY_PRESET_REVERB,
                NOTIFY_ENVIRONMENTAL_REVERB,
                NOTIFY_HQ_EQUALIZER,
        };
    ...
    protected void onModeSelectLiteItemClick(int position) {
        ...
        switch (position) {
            case 0:
                type = EventDefs.NavigationDrawerReqEvents.IMPL_TYPE_STANDARD;
                break;
            case 1:
                type = EventDefs.NavigationDrawerReqEvents.IMPL_TYPE_OPENSL;
                break;
            default:
                return;
        }

        postAppEvent(EventDefs.NavigationDrawerReqEvents.PLAYER_SET_IMPL_TYPE, type, 0);
    }
    ...
    private void onPageSelectListItemClick(int position) {
        ...
        postAppEvent(
                EventDefs.NavigationDrawerReqEvents.SELECT_PAGE,
                position, 0);
    }
