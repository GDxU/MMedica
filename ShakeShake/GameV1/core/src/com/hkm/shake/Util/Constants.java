...
public class Constants {
    public static final String GAME_NAME = "Shake Shake ICHRAN!";
    ...
    public static final String BACKGROUND_IMAGE_PATH = "game/ice.png";
    public static final String APP_SPLASH_LOGO = "logo.png";
    public static final String GROUND_IMAGE_PATH = "game/ground.png";

    public static final float WORLD_TO_SCREEN = 32;
    public static final float RUNNING_SPEED = 10;


    public static final String SPRITES_ATLAS_PATH = "sprites.txt";
    public static final String CHARACTERS_ATLAS_PATH = "game/characters.txt";
    ...
    public static final String RUNNER_JUMPING_SOUND = "bgm/jump.wav";
    public static final String RUNNER_HIT_SOUND = "bgm/hit.wav";
    public static final String GAME_MUSIC = "bgm/fun_in_a_bottle.mp3";
